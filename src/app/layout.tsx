...
export const url = 'cop-slots.com';
const ogTitle =
  'Cop Slots Casino UK – Secure Online Gaming and Fast Payouts';
const ogSiteName = 'Cop Slots Casino UK';
const metaDescription =
  'Cop Slots Casino UK delivers slots, jackpots, and live games with trusted payments and cashouts. Sign up today to unlock bonuses, free spins, and quick cash withdrawals.';
