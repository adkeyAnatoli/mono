...
import data from '@/src/app/data/dataLanguageCurrency.json';
...
const LanguageCurrencySection = () => {
  ...
  return (
    <section id="lang" className={layout.section}>
...
export default LanguageCurrencySection;
