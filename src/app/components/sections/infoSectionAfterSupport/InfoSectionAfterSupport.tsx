...
const InfoSectionAfterSupport = () => {
  const sections: SectionData[] = [
    {
      heading: infoData.fit.heading,
      content: [{ type: 'list-dotted', items: infoData.fit.items }],
    },
    {
      heading: infoData.notFit.heading,
      content: [{ type: 'list-dotted', items: infoData.notFit.items }],
    },
  ];
  ...
  const hasTableInBlock =
    contentHasTable(data.content) ||
    data.sections.some((s) => contentHasTable(s.content));
