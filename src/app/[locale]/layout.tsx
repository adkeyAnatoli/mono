  ...
  return (
    <html lang={locale}>
      <head>
        ...
        <link rel="icon" href="/icons/icon192.png" type="image/png" sizes="192x192" />
      </head>
      <body className={`${fontTwo.className} ${fontOne.className}`}>
        <NextIntlClientProvider>
          <RedirectProvider>{children}</RedirectProvider></NextIntlClientProvider>
      </body>
    </html>
  );
}
