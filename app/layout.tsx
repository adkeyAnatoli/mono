...
const ogTitle =
  'Facilito Bet Venezuela – Plataforma de apuestas deportivas y casino';
const ogSiteName = 'Facilito Bet Venezuela';
const metaDescription =
  'Facilito Bet Venezuela ofrece apuestas deportivas seguras, tragamonedas y juegos de casino en vivo bajo la regulación de la DGOJ. Regístrese ahora para acceder a métodos de pago locales y funciones de juego verificadas.';
...
export default function RootLayout({
  ...
  return (
    <html lang={locale}>
      ...
      <body
        className={`${fontTwo.className} ${fontThree.className} ${fontOne.className}`}
      >
