...
export const url = 'luckyboys-casino-online.com';
const ogTitle =
  'Lucky Boys Casino UK – Trusted Online Gaming, Slots & Live Play';
const ogSiteName = 'Facilito Bet Venezuela';
const metaDescription =
  'Lucky Boys Casino UK offers licensed slots, live dealer tables, and safe payments in a secure environment. Start today and explore exclusive bonuses with fast registration.';

const locale = 'en-GB';
// const language = 'German';
const ogImage = `https://${url}/og-img.webp`;

const fontOne = Ubuntu({
  weight: ['700'],
  subsets: ['latin'],
});
