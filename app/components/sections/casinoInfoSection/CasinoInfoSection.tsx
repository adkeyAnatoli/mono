      ...
      <div className={`${style.wrapper} container`}>
        ...
        <div className={style.firstBlock}>
          <div className={style.firstBlock_text}>
            ...
            <p className="text">{data['title-text']}</p>
          </div>
        ...
        <div className={style.middleBlock}>
          ...
          <p className="text">{data['first-section-text-top']}</p>
          <ul>
          ...
          <p className="text">{data['first-section-text-bottom']}</p>
        </div>
        <div className={style.middleBlock}>
          <h3 className={`${style.title} title-white title-small`}>
            {data['second-section-title']}
          </h3>
          <p className="text">{data['second-section-text']}</p>
        </div>
        ...
        <div className={style.middleBlock}>
          ...
          <p className="text">{data['third-section-text']}</p>
        </div>
        ...
        <div className={`listBlock lastBlock gap-64`}>
          {data.list.map((elem, index) => (
            <div className="lastBlockElement" key={index}>
              ...
              <div>
                <p className="text">{elem.contentList!.topText}</p>
                ...
                <p className="text">{elem.contentList!.lastText}</p>
              </div>
            </div>
          ))}
        </div>
